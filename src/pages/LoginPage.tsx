...
const LoginPage = () => {
  ...
  const handleGoogle = async () => {
    ...
    if (oauthError) {
      setError("Não foi possível entrar com Google. Verifique se o provedor está configurado no Supabase.");
      setLoading(false);
      return;
    }
    // Redirect happens via Supabase; no need to navigate manually
  };
